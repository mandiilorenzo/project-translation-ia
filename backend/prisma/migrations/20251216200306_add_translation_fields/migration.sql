/*
  ...
  - The values [PROCESSING] on the enum `ArticleStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "ArticleStatus_new" AS ENUM ('PENDING', 'TRANSLATING', 'COMPLETED', 'FAILED');
...
-- AlterTable
ALTER TABLE "articles" ADD COLUMN     "completedAt" TIMESTAMP(3);
