...
type TranslationState = 'idle' | 'uploading' | 'processing' | 'completed'
            ...
            `}
                    ...
                    {(status === 'uploading' || status === 'processing') && (
                        <div className="bg-white border border-slate-200 rounded-3xl p-10 shadow-sm animate-fade-in-up">
                            <div className="flex flex-col items-center text-center">
                                ...
                                <p className="text-slate-500 h-6 mb-8 font-medium font-mono text-sm">
                                    {status === 'processing' && (
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="bg-slate-50 rounded-xl p-4 border border-slate-200 mb-8 flex items-center justify-between">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <p className="font-semibold text-slate-900 text-sm">{file?.name.replace('.pdf', '_PT-BR.pdf')}</p>
                                                <p className="text-xs text-slate-500">PDF • Pronto para download</p>
                                            </div>
                                        </div>
                                    ...
                                    <div className="flex gap-4">
                                        <Button size="lg" className="shadow-xl shadow-teal-600/20">
                                            <Download className="w-5 h-5 mr-2" /> Baixar Arquivo Traduzido
                                        </Button>
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-slate-900 p-6 rounded-2xl border border-slate-800 text-white relative overflow-hidden">
                        <div className="absolute top-0 right-0 w-24 h-24 bg-teal-500 rounded-full blur-3xl opacity-20 -mr-10 -mt-10"></div>

                        <h4 className="font-semibold mb-2 relative z-10">Glossário Ativo</h4>
                        <p className="text-sm text-slate-400 mb-4 relative z-10">
                            Sua tradução utilizará seu glossário personalizado de Cardiologia.
                        </p>
                        <div className="flex flex-wrap gap-2 relative z-10">
                            <span className="text-[10px] bg-slate-800 border border-slate-700 px-2 py-1 rounded text-teal-400">Heart Failure</span>
                            <span className="text-[10px] bg-slate-800 border border-slate-700 px-2 py-1 rounded text-teal-400">Myocardium</span>
                            <span className="text-[10px] bg-slate-800 border border-slate-700 px-2 py-1 rounded text-teal-400">+24</span>
                        </div>
                    </div>
                </div>
